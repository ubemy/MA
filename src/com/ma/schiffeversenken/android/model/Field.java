...
public class Field {
	...
	/**
	 * �berladener Konstruktor erstellt ein Field Objekt
	 * 
	 * @param typ
	 *            Typ des Spielfelds (0=Eigenes Spielfeld, 1=Gegnerisches
	 *            Spielfeld)
...
//					fieldBytes = (BluetoothConnectedThread.BLUETOOTH_ENEMY_FIELD+subStringPart).getBytes();					
//					
//					System.out.println("Send_Sub    "+subStringPart+"      gr��e:"+subStringPart.length());
//					System.out.println("Send_Full   "+fieldBytes+"      gr��e:"+fieldBytes.length);		
//					//Deserialisierung
//					String readMsg="";
...
//							//Ende simulieren
//							System.out.println("Substring l�nge muss:"+subString.length());
//							System.out.println("Substring l�nge ist :"+subStringIncomeing.length());
				...
				for(int j=0;j<fieldUnitsDesc.size();j++){
					...
					shipLastUnit=unit;
						...
						if(j<1){
							...
							//Definieren der Schiffstexturen lt. Ausrichtung gem�� Vorg�nger
