...
public class FieldUnit {
	...
	boolean occupied;
	/**Wenn das Feldelement direkt an einer oder zwei Kante\n liegt, gibt dieser Wert die Richtung der Kante\n an:
	 * 1=Obere Kante, 2=Untere Kante, 3=Rechte Kante, 4=Linke Kante*/
	int edge1=0, edge2=0;
	 ...
	 * @param id Die eindeutige ID dieses Feldelements
	...
	/**
	 * Gibt zurueck ob auf diesem Feldelement ein Vorder-, Mittel- oder Hinterteil des Schiffs liegt
	 ...
	 * @param attacked True oder False ob das Feldelement attackiert wurde
	 */
	 ...
	 * @param edge 1 = 1. Kante oder 2 = 2. Kante des Feldelements
	 * @param value Art der Kante: 1 = Obere Kante, 2 = Untere Kante, 3 = Rechte Kante, 4 = Linke Kante
	 */
	 ...
	 * @param edge 1 = 1. Kante oder 2 = 2. Kante des Feldelements
	 * @return Art der Kante: 1 = Obere Kante, 2 = Untere Kante, 3 = Rechte Kante, 4 = Linke Kante
	 */
	 ...
	 * @param lNeighbor Linker Nachbar
	 * @param rNeighbor Rechter Nachbar
	 * @param oNeighbor Oberer Nachbar
	 * @param uNeighbor Unterer Nachbar
	 */
	 ...
	 * @param ship Das Schiff, das auf diesem Feldelement platziert wird
	 * @param shipSegment Segment des Schiffs: 0=Vorderteil, 1=Mittelteil, 2=Hinterteil
	 */
	 ...
	 * @param occupied True oder False ob das Feldelement belegt ist
	 */
